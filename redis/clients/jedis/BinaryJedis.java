...
public class BinaryJedis implements BasicCommands, BinaryJedisCommands, MultiKeyBinaryCommands, AdvancedBinaryJedisCommands, BinaryScriptingCommands, Closeable
{
    ...
    public Set<byte[]> keys(final byte[] pattern) {
        ...
        final HashSet<byte[]> keySet = new HashSet<byte[]>(this.client.getBinaryMultiBulkReply());
        return keySet;
    }
    ...
    public Set<Tuple> zrangeWithScores(final byte[] key, final long start, final long end) {
        ...
        final Set<Tuple> set = this.getBinaryTupledSet();
        return set;
    }
    ...
    public List<byte[]> blpop(final int timeout, final byte[]... keys) {
        ...
        this.client.blpop(args.toArray(new byte[args.size()][]));
        this.client.setTimeoutInfinite();
        final List<byte[]> multiBulkReply = this.client.getBinaryMultiBulkReply();
    ...
    public List<byte[]> brpop(final int timeout, final byte[]... keys) {
        ...
        args.add(Protocol.toByteArray(timeout));
        this.client.brpop(args.toArray(new byte[args.size()][]));
        this.client.setTimeoutInfinite();
        final List<byte[]> multiBulkReply = this.client.getBinaryMultiBulkReply();
        this.client.rollbackTimeout();
        return multiBulkReply;
    ...
    public byte[] brpoplpush(final byte[] source, final byte[] destination, final int timeout) {
        ...
        this.client.setTimeoutInfinite();
        final byte[] reply = this.client.getBinaryBulkReply();
        this.client.rollbackTimeout();
        return reply;
    }
    ...
    private byte[][] getParams(final List<byte[]> keys, final List<byte[]> args) {
        ...
        final byte[][] params = new byte[keyCount + args.size()][];
