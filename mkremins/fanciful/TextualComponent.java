...
public abstract class TextualComponent implements Cloneable
{
    ...
    private static final class ArbitraryTextTypeComponent extends TextualComponent implements ConfigurationSerializable
    {
        ...
        public Map<String, Object> serialize() {
            return new HashMap<String, Object>() {
                {
                    ((HashMap<String, String>)this).put("key", ArbitraryTextTypeComponent.this.getKey());
                    ((HashMap<String, String>)this).put("value", ArbitraryTextTypeComponent.this.getValue());
                }
            };
        }
    ...
    private static final class ComplexTextTypeComponent extends TextualComponent implements ConfigurationSerializable
    {
        ...
        public Map<String, Object> serialize() {
            return new HashMap<String, Object>() {
                {
                    ((HashMap<String, String>)this).put("key", ComplexTextTypeComponent.this.getKey());
                    for (final Map.Entry<String, String> valEntry : ComplexTextTypeComponent.this.getValue().entrySet()) {
                        ((HashMap<String, String>)this).put("value." + valEntry.getKey(), valEntry.getValue());
                    }
                }
            };
        }
